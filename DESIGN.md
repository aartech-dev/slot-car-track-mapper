...
- Run `main.py` on real hardware for the first time and work through its documented calibration steps: `LAP_THRESHOLD` against the actual IR marker, and the gyro-sign/optical-axis sanity checks (§6).
